...
<div class="bg-white shadow-md rounded-lg p-6">
    ...
    <form action="{{ route('peminjaman.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="tanggal_pinjam" id="tanggal_pinjam" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('tanggal_pinjam') border-red-500 @enderror" value="{{ old('tanggal_pinjam', \Carbon\Carbon::now()->format('Y-m-d')) }}">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="tanggal_kembali" id="tanggal_kembali" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('tanggal_kembali') border-red-500 @enderror" value="{{ old('tanggal_kembali', \Carbon\Carbon::now()->addDays(7)->format('Y-m-d')) }}">
